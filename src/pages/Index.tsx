    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 flex items-center justify-center relative overflow-hidden">
      ...
      <div className="text-center z-10 max-w-4xl mx-auto px-6 animate-fade-in">
        ...
        <p className="text-xl md:text-2xl text-gray-600 mb-12 max-w-2xl mx-auto leading-relaxed">
          Discover the power of computer vision with our interactive corner detection algorithms. 
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          ...
          <div className="animate-fade-in" style={{ animationDelay: '0.8s' }}>
            <div className="text-3xl font-bold text-indigo-600">Modern</div>
...
const InputSection = () => {
  ...
  const sampleImages = [
    { id: 'building', name: 'Architecture', url: 'https://images.unsplash.com/photo-1486718448742-163732cd1544?w=400&h=300&fit=crop' },
    { id: 'tech', name: 'Technology', url: 'https://images.unsplash.com/photo-1488590528505-98d2b5aba04b?w=400&h=300&fit=crop' },
    { id: 'code', name: 'Code Monitor', url: 'https://images.unsplash.com/photo-1461749280684-dccba630e2f6?w=400&h=300&fit=crop' },
  ];
...
const MethodSection = () => {
  ...
  const methods = [
    ...
    { id: 'hit-miss', name: 'Hit and Miss', description: 'Morphological corner detection' },
    { id: 'shi-tomasi', name: 'Shi-Tomasi', description: 'Improved Harris corner detector' },
  ...
  return (
    <div className="bg-white rounded-3xl shadow-xl p-8 animate-fade-in flex flex-col justify-center" style={{ animationDelay: '0.2s' }}>
      <h2 className="text-2xl font-bold text-gray-800 mb-6 flex items-center">
...
const OutputSection = () => {
  return (
    <div className="bg-white rounded-3xl shadow-xl p-8 animate-fade-in" style={{ animationDelay: '0.4s' }}>
      <h2 className="text-2xl font-bold text-gray-800 mb-6 flex items-center">
